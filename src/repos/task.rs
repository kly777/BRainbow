    ...
    pub async fn find_detail(&self, id: i32) -> Result<Option<TaskDetailResponse>, sqlx::Error> {
        ...
        for window in time_windows {
            match window.window_type {
                crate::entity::TimeWindowType::Feasible => available_slots.push(window),
                crate::entity::TimeWindowType::Planned => planned_slots.push(window),
                crate::entity::TimeWindowType::Actual => actual_slots.push(window),
            }
        }
