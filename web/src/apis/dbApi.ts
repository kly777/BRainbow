...
const RowSchema = Schema.Array(Schema.Union(Schema.String, Schema.Number, Schema.Null));
...
export const getTableData = (name: string): Effect.Effect<TableData, ApiErrorType> =>
