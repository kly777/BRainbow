                    ...
                    <h2 class={styles.statusTitle}>
                        <span
                            class={`${styles.statusIndicator} ${
                                getStatusColorClass(TaskStatus.BACKLOG)
                            }`}
                        >
                        </span>
            ...
            <Show when={groupedTasks().active.length > 0}>
                <div class={styles.statusSection}>
                    <h2 class={styles.statusTitle}>
                        <span
                            class={`${styles.statusIndicator} ${
                                getStatusColorClass(TaskStatus.ACTIVE)
                            }`}
                        >
                        </span>
            ...
            <Show when={groupedTasks().completed.length > 0}>
                <div class={styles.statusSection}>
                    <h2 class={styles.statusTitle}>
                        <span
                            class={`${styles.statusIndicator} ${
                                getStatusColorClass(TaskStatus.COMPLETED)
                            }`}
                        >
                        </span>
            ...
            <Show when={groupedTasks().archived.length > 0}>
                <div class={styles.statusSection}>
                    <h2 class={styles.statusTitle}>
                        <span
                            class={`${styles.statusIndicator} ${
                                getStatusColorClass(TaskStatus.ARCHIVED)
                            }`}
                        >
                        </span>
