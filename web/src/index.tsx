			...
			<header class={styles.appHeader}>
				<div class={styles.headerContent}>
					...
					<nav class={`${styles.navLinks} ${menuOpen() ? styles.navOpen : ""}`}>
						<A href="/" class={styles.navLink} activeClass={styles.active} end onClick={() => setMenuOpen(false)}>
							主页
						</A>
						<A href="/tasks" class={styles.navLink} activeClass={styles.active} end onClick={() => setMenuOpen(false)}>
							任务
						</A>
						<A href="/c" class={styles.navLink} activeClass={styles.active} end onClick={() => setMenuOpen(false)}>
							卡片
						</A>
						<A href="/o" class={styles.navLink} activeClass={styles.active} end onClick={() => setMenuOpen(false)}>
							本体
						</A>
						<AuthStatus />
					</nav>
