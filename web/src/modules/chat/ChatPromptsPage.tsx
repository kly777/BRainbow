...
import { createPresetE, deletePresetE, updatePresetE } from "@modules/chat";
...
export default function ChatPromptsPage() {
	...
	onMount(async () => {
		const r = await import("@lib/utils").then((m) =>
			m.tryAsync(() => import("@modules/chat").then((a) => a.listPresetsE())),
		);
