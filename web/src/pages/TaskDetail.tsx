        ...
        <Match when={task()}>
          <>
            ...
            <div class="info-grid">
              <div class="info-card">
                ...
                <div class="info-content">
                  <p><span class="info-label">ID:</span> {task()!.id}</p>
                  <p><span class="info-label">标题:</span> {task()!.title}</p>
                  <p><span class="info-label">描述:</span> {task()!.description || "无描述"}</p>
                  <p><span class="info-label">创建时间:</span> {formatDate(task()!.created_at)}</p>
                </div>
              </div>
            </div>
            ...
            <div class="section">
              ...
              <Show
                when={taskDetail()?.sub_tasks && taskDetail()!.sub_tasks.length > 0}
                fallback={
                  <div class="empty-state">
                    <p>暂无子任务</p>
                    ...
                    {(subTask) => (
                      <div class="card">
                        ...
                        <div class="card-content">
                          ...
                          <p><small>创建时间: {formatDate(subTask.created_at)}</small></p>
                        </div>
                      </div>
                    )}
                  </For>
            ...
            <div class="section">
              ...
              <Show
                when={taskDetail()?.dependencies && taskDetail()!.dependencies.length > 0}
                fallback={
                  <div class="empty-state">
                    <p>暂无依赖任务
</p>
                    ...
                    {(dependency) => (
                      <div class="card">
                        ...
                        <div class="card-content">
                          ...
                          <p><small>创建时间: {formatDate(dependency.created_at)}</small></p>
                        </div>
                      </div>
                    )}
                  </For>
            ...
            <div class="section">
              ...
              <Show 
                when={taskDetail()?.time_windows && taskDetail()!.time_windows.length > 0}
                fallback={
                  <div class="empty-state">
                    <p>暂无时间窗口</p>
