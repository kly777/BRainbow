...
const TaskFormPage: Component<{ editMode?: boolean }> = (props) => {
  ...
  const handleSubmit = async (e: Event) => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : (props.editMode ? "更新任务失败" : "创建任务失败"));
  ...
  return (
    <div class="container">
      <div class="header">
        ...
        <div class="actions">
          <button class="secondary" onClick={handleCancel}>取消</button>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div class="form-actions">
          <button type="submit" disabled={loading()}>
            <Show when={loading()} fallback={props.editMode ? "更新任务" : "创建任务"}>
              处理中...
            </Show>
          </button>
