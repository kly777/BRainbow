                                ...
                                <div class={styles.card}>
                                        ...
                                        fallback={
                                            <>
                                                <div class={styles.preview}>
                                                    <Show when={item.media_type === "image"}>
                                                        <a href={item.url} target="_blank" rel="noopener noreferrer">
                                                            <img src={item.url} alt={item.original_name} class={styles.thumb} loading="lazy" />
                                                        </a>
                                                    </Show>
                                                    <Show when={item.media_type !== "image"}>
                                                ...
                                                <div class={styles.actions}>
                                                    <button type="button" class={styles.btn} onClick={() => startRename(item)}>
                                                        重命名
                                                    </button>
                                                    <button type="button" class={`${styles.btn} ${styles.btnDanger}`} onClick={() => handleDelete(item.stored_id)}>
                                                        删除
                                                    </button>
                                                </div>
                                            </>
                                    ...
                                    >
                                        <div class={styles.editRow}>
                                            ...
                                            />
                                            <button type="button" class={styles.btn} onClick={handleRename}>
                                                保存
                                            </button>
                                            <button type="button" class={styles.btn} onClick={() => setEditingId(null)}>
                                                取消
                                            </button>
                                        </div>
                                    </Show>
