import { trySync, unwrapOrNull } from "@shared/lib/result.ts";
...
export class Color {
	...
	toOklab(): Oklab {
		const lr = this.toLinearRgb();
		const l = 0.4122214708 * lr.r + 0.5363325363 * lr.g + 0.0514459929 * lr.b;
		const m = 0.2119034982 * lr.r + 0.6806995451 * lr.g + 0.1073969566 * lr.b;
		const s = 0.0883024619 * lr.r + 0.2817188376 * lr.g + 0.6299787005 * lr.b;
		return {
			L:
